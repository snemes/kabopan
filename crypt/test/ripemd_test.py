...
ass(ripemd160_.IVs,IVs, "ripemd160 IVs")
ass(ripemd160_.ks, k , "K")
ass(ripemd160_.Ks, K, "K'")
...
class test(ripemd320):
    def __init__(self):
        ...
        ass(self.IVs, IVs, "ripemd320 IVs")
test()
...
ass(ripemd128_.IVs, IVs, "ripemd128 IVs")

ass(ripemd128_.ks, [0x00000000, 0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC], "K")
ass(ripemd128_.Ks, [0x50A28BE6, 0x5C4DD124, 0x6D703EF3, 0x00000000], "K'")
